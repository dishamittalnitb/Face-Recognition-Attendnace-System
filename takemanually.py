...
def manually_fill():
    ...
    sb.title("Enter Department name...")
    sb.geometry("580x320")
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def err_screen1():
                ...
                tk.Label(
                    errsc2,
                    text="Please enter Employee Name & ID!",
                    fg="red",
                    bg="white",
                    font=("times", 16, " bold "),
                ).pack()
            ...
            def enter_data_DB():
                ...
                if ENROLLMENT == "":
                    ...
                    if index == 0:
                        d = {
                            index: {"EmployeeID": ENROLLMENT, "Name": STUDENT, Date: 1}
                        }
                        index += 1
                        ENR_ENTRY.delete(0, "end")
                        STUDENT_ENTRY.delete(0, "end")
                    else:
                        d[index] = {"EmployeeID": ENROLLMENT, "Name": STUDENT, Date: 1}
                        index += 1
                        ENR_ENTRY.delete(0, "end")
                        STUDENT_ENTRY.delete(0, "end")
